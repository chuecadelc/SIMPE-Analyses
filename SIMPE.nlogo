...
Adam-Troian, J, Mahfud Y, Urbanska K, and Guimond S. (2020) The role of social identity in the explanation of collective action: An intergroup perspective on the Yellow Vests movement. Journal of Applied Social Psychology, 21(0), pp.1â€“17.
...
Edmonds, B. (2021) â€œA data-informed bounded-confidence opinion dynamics modelâ€ (Version 0.3.0). CoMSES Computational Model Library. Retrieved from: https://www.comses.net/codebases/537b40cf-e300-4245-bcc6-427b53515bf6/releases/0.3.0/
...
Flache, F. (2018) Between monoculture and cultural polarization: Agent-based models of the interplay of social influence and cultural diversity.Journal of Archaeological Methods Theory, 25, pp.996â€“1023

Flache, A., Mas, M., Feliciani, T., Chattoe-Brown, E., Deffuant, G., Huet, S. and Lorenz, J. (2017) Models of social influence: Towards  thenext frontiers. Journal of Artificial Societies and Social Simulations, 20, pp.1â€“31
...
Lubbers, M.; Molina, J.L. and Valenzuela-GarcÃ­a, H. (2019) When networks speak volumes: Variation in the size of broader acquaintanceship networks, Social Networks, 56, pp.55-69
